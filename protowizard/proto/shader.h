...
public:
	...
	void SetVec3(GLint variable, const glm::vec3 &v) const							{ glUniform3f(variable, v.x, v.y, v.z);		}
	void SetVec4(GLint variable, const glm::vec4 &v) const							{ glUniform4f(variable, v.x, v.y, v.z, v.a); }
